...
<body>
   ...
   <?php
                ...
                ?>
                    ...
                    <button type="button"><a href="add-category.php">Add New Category</a></button>
   ...
   <div class="category">
       ...
       <table>
           ...
           <tr>
               ...
               <td><a href="category-update.php?id=<?php echo $row['cid']; ?>"><i class="fa fa-edit"></i></a></td>
               <td><a href="category-delete.php?id=<?php echo $row['cid']; ?>"><i class="fa fa-trash"></i></a></td>
           </tr>
           <?php
            }
